    ...
    <q-dialog v-model="showDialog" persistent @show="onDialogShow">
      <q-card style="min-width: 400px; border-radius: 16px;">
        <q-card-section class="row items-center q-pb-none bg-primary text-white q-pa-md">
          <div class="text-h6 text-weight-bold">{{ isEditing ? 'Steuersatz bearbeiten' : 'Neuer Steuersatz' }}</div>
          <q-space />
        ...
        <q-card-section class="q-pa-lg">
          <q-form @submit="onSubmit" class="q-gutter-md">
            ...
            <div class="row justify-end q-mt-lg q-gutter-x-sm">
              <q-btn ref="cancelBtn" label="Abbrechen" color="negative" outline rounded @click="closeDialog"
                     padding="xs lg"/>
              <q-btn ref="saveBtn" :label="isEditing ? 'Aktualisieren' : 'Speichern'" type="submit" color="primary"
